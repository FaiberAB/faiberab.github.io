...
<body>
  ...
  <form id="tensionForm">
    ...
    <input type="number" name="anguloA" step="any" required><br><br>

    <label for="anguloB">Ángulo B (°):</label>
    <input type="number" name="anguloB" step="any" required><br><br>

    <label for="masa">Masa (kg):</label>
    <input type="number" name="masa" step="any" required><br><br>

    <button type="submit">Calcular</button>
  </form>

  <div id="resultado" style="display:none;">
    <p><strong>T1:</strong> <span id="t1"></span> N</p>
    <p><strong>T2:</strong> <span id="t2"></span> N</p>
    <p><strong>Peso (T3):</strong> <span id="t3"></span> N</p>
    <p>Ángulo de T1: <span id="anguloT1"></span>°</p>
    <p>Ángulo de T2: <span id="anguloT2"></span>°</p>
  </div>
